...
public class AdminController implements Initializable {
    ...
    @FXML
    private void loadStudentsData(ActionEvent event)throws SQLException{
        try {
        ...
        this.lastnamecolumn.setCellValueFactory(new PropertyValueFactory<StudentData, String>("secondName"));
